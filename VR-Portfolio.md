...
<div class="portfolio-grid">
  ...
  <div class="project-card" onclick="openModal('gearbox')">
    <img src="./gearbox.png" alt="Gear Box Assembly VR" class="project-image">
  ...
  <div class="project-card" onclick="openModal('inspection')">
    <img src="./inspection.png" alt="Inspection VR" class="project-image">
  ...
  <div class="project-card" onclick="openModal('measurement')">
    <img src="./measurement.png" alt="Measurement VR" class="project-image">
  ...
  <div class="project-card" onclick="openModal('npc')">
    <img src="./npc.png" alt="NPC VR" class="project-image">
  ...
  <div class="project-card" onclick="openModal('tabletennis')">
    <img src="./vr_table_tennis.png" alt="VR Table Tennis" class="project-image">
  ...
  <div class="project-card" onclick="openModal('gorilla')">
    <img src="./gorilla_vs_100men.jpg" alt="Gorilla vs 100 Men" class="project-image">
